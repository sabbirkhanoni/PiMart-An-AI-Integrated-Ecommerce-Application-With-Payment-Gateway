...
const ProductDisplayCard = ({ productData }) => {
  ...
  return (
    <Link to={URL}>
      <div className="lg:h-[380px] h-[300px] lg:w-[350px] border border-gray-200 p-2 lg:p-4 lg:space-y-3 grid max-w-56.5 w-[195px] rounded shadow-lg overflow-hidden hover:shadow-lg ">
