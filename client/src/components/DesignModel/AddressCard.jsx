...
const AddressCard = ({
  ...
  return (
    <div
      className={`relative overflow-hidden rounded-xl border border-blue-500 ${selectedAddress === index ? "bg-blue-200" : "bg-blue-50"} shadow-sm`}
    >
        ...
        <div className="pl-3 py-2 hover:bg-green-100 hover:border-green-300 transition-colors duration-300">
          ...
          <div className="border-t border-gray-100 pt-3 space-y-3">
            ...
            <div className="flex items-center gap-2 pt-2 border-t border-gray-100">
              ...
              <p className="text-[13px] text-gray-900">{address.mobile}</p>
            </div>
          </div>
        </div>
      </label>
