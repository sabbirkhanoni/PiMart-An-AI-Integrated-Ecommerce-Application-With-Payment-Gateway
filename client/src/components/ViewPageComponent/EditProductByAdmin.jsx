...
import AddNewFeildsComponent from "../Mini/AddNewFeildsComponent";
...
const EditProductByAdmin = ({productData, close, fetchAllProducts}) => {
  ...
  return (
    <section className='top-0 left-0 bottom-0 right-0 fixed bg-neutral-500/50 z-50 overflow-y-auto p-5 '>
        <div className='p-4 mx-auto bg-white shadow-lg rounded max-w-3xl w-full'>
            <section >
                <div className='p-2 bg-white shadow-md rounded flex justify-between items-center'>
                    <h2 className='font-semibold'>Edit Products</h2>
                    <button onClick={close}><IoIosCloseCircle className='text-red-500 cursor-pointer text-3xl' /></button>
                </div>
