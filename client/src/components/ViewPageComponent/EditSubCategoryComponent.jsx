...
const EditSubCategoryComponent = ({ close, data, fetchSubCategoriesDataAgainToAvoidRefresh }) => {
  ...
  const handleSubmitSubCategory = async (e) => {
    ...
    try {
      ...
      if (responseData.success) {
        ...
        if(fetchSubCategoriesDataAgainToAvoidRefresh) {
          fetchSubCategoriesDataAgainToAvoidRefresh();
        }
    ...
    >
      <div className="w-full max-w-6xl bg-white rounded p-4">
        <div className="flex justify-between items-center gap-3">
          <h1 className="text-lg font-">Edit Sub Category</h1>
...
EditSubCategoryComponent.propTypes = {
